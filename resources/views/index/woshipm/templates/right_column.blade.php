<div class="right-column">
    <div class="sidebar">
            ...
            <ul class="widget-author-list">
                <li class="widget-author-list-item u-clearfix"><a href="http://www.woshipm.com/u/57956" target="_blank"><img
                    ...
                    <div class="widget-author-list-content"><h4><a href="http://www.woshipm.com/u/57956"
                                        ...
                                        class="iconfont icon-labelv"></span></a></h4>
                        <p>“秒嗨"运营负责人</p></div>
                </li>
        ...
        <aside id="books-2" class="widget widget_books">
            <h3 class="widget-title">好书推荐
                <div class="u-floatRight books-nav"><span class="prev"><i
                                class="icon-zuoqiehuan iconfont"></i></span><span
                            class="next"><i class="icon-youqiehuan iconfont"></i></span></div>
            </h3>
            <div class="tempWrap" style="overflow:hidden; position:relative; width:280px">
                <ul class="rec-books"
                    style="width: 1120px; left: 0px; position: relative; overflow: hidden; padding: 0px; margin: 0px;">
                    <li style="float: left; width: 280px;">
                        <div class="rec-book-item" data-id="1">
                            ...
                            <p class="rec-book-des">39位一线运营专家，9大方面总结数十家大型互联网企业的50个最佳实践！</p>
                        </div>
                        <div class="rec-book-item" data-id="2">
                            ...
                            <p class="rec-book-des">运营界有两本书，一本叫以前的运营，一本叫进化式运营。</p>
                        </div>
                    </li>
                    <li style="float: left; width: 280px;">
                        <div class="rec-book-item" data-id="3">
                            ...
                            <p class="rec-book-des">传授十万用户、百万粉丝的运营心经；腾讯科技、易到共同推荐的运营宝典</p>
                        </div>
                        <div class="rec-book-item" data-id="4">
                            ...
                            <p class="rec-book-des">互联网运营经验倾囊分享，教你如何做一名互联网产品宣传项目操盘手</p>
                        </div>
                    </li>
                    <li style="float: left; width: 280px;">
                        <div class="rec-book-item" data-id="5">
                            ...
                            <p class="rec-book-des">产品必读技术科普，全面梳理产品经理必懂的技术知识体系架构。</p>
                        </div>
                    ...
                    <li style="float: left; width: 280px;">
                        <div class="rec-book-item" data-id="7">
                            ...
                            <p class="rec-book-des">硅谷知名创业者力作，帮助产品人打造数据驱动的思维模式。</p>
                        </div>
                        <div class="rec-book-item" data-id="8">
                            ...
                            <p class="rec-book-des">以豆瓣早期和搜狗输入法的真实案例，帮助读者深刻理解产品。</p>
                        </div>
                    </li>
                </ul>
            </div>
            <div class="rec-book-bottom"><a href="http://dh.woshipm.com/book/" target="_blank">更多
                    <svg class="svgIcon-use" viewBox="0 0 19 19" height="19" width="19">
                        <path fill-rule="evenodd"
                              d="M7.6 5.138L12.03 9.5 7.6 13.862l-.554-.554L10.854 9.5 7.046 5.692"></path>
                    </svg>
                </a></div>
        </aside>
    </div>
