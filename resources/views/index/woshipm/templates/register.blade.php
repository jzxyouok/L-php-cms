    ...
    <div class="lo_main">
        <form action="" name="registerForm">
                ...
                <ul class="login_ul" ng-show="registerStyle && !registerSuccess && !registerFail">
                    <li class="mar_t15">
                        ...
                        <input id="" name="phone" type="text" ng-model="phone" class="lo_input hei_font"
                               placeholder="手机号"
                               ng-pattern="/^0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$/" required
                               ng-blur="checkAccount()">
                    </li>
                    <li class="mar_t15">
                    ...
                    <li class="mar_t15">
                        ...
                        <input id="phone_password" name="phonePassword" type="password" ng-model="phonePassword"
                               class="lo_input hei_font" placeholder="密码"
                               ng-pattern="/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,21}$/" required>
                    </li>
                    <li class="mar_t15">
                        <span class="lo_left">确认密码</span>
                        <input id="" name="phoneRePassword" type="password" class="lo_input hei_font" placeholder="确认密码"
                               ng-pattern="/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,21}$/" required
                               pw-check="phone_password" ng-model="phoneRePassword">
                    </li>
                ...
                <ul class="login_ul ng-hide" ng-show="showSendEmail">
                   ...
                   <li  style="    height: 30px;    line-height: 30px;"> <span class="lo_left">&nbsp;</span>为了账号安全，需要验证邮箱有效性</li>
                    ...
                    <li class="mar_t15">
                        ...
                        <span id="" style="">
							<a href="javascript:void(0);" class="yzm_pic float_r" id="">重新发送</a>
						</span>
                    </li>
                    <li class="mar_t15 po_rela">
                        <span class="lo_left">&nbsp;</span>
                    ...
                    <li class=" po_rela" style="    height: 30px;    line-height: 30px;">
                        <span class="lo_left">&nbsp;</span>
                        <div style="text-align: left;">
                            <a href="javascript:void(0);" class="float_l " ng-click="usePhone()">手机号注册</a>
                            <a href="javascript:void(0);" class="float_r " ng-click="usePhone()">收到不验证码？</a>
                        </div>
                    </li>

                </ul>
                <div id="" class="ng-hide" style="font-size: 16px;text-align: center;margin: 50% auto;"
                     ng-show="registerFail">
            ...
            <ul class="regist_tips_ul y2" ng-show="registerStyle">
                <li id="" style="position: absolute;top: 0px" class="ng-hide"
                    ng-show="registerForm.phone.$invalid && !registerForm.phone.$pristine">手机号码格式有误！
                </li>
                <li id="" style="position: absolute;top: 40px" class="mar_t15 ng-hide"
                    ng-show="registerForm.phone.$invalid && !registerForm.phone.$pristine">验证码错误！
                </li>
                <li id="" style="position: absolute;top: 95px" class="mar_t15 ng-hide"
                    ng-show="registerForm.phonePassword.$invalid && !registerForm.phonePassword.$pristine">
                    密码由6-21字母和数字组成！
                </li>
                <li id="" style="position: absolute;top: 150px" class="mar_t15 ng-hide"
                    ng-show="registerForm.phoneRePassword.$invalid && !registerForm.phoneRePassword.$pristine">两次密码不一致！
                </li>
            </ul>
            <ul class="regist_tips_ul y2 ng-hide" ng-show="!registerStyle">
                <li id="" style="position: absolute;top: 0px" class="ng-hide"
                    ng-show="registerForm.email.$invalid && !registerForm.email.$pristine">邮箱格式不正确！
                </li>
                <li id="" style="position: absolute;top: 0px" class="ng-hide"
                    ng-show="!registerForm.email.$pristine && exist">邮箱已经被注册！
                </li>
                <li id="" style="position: absolute;top: 40px" class="mar_t15 ng-hide"
                    ng-show="registerForm.emailPassword.$invalid && !registerForm.emailPassword.$pristine">
                    密码由6-21字母和数字组成!
                </li>
                <li id="" style="position: absolute;top: 95px" class="mar_t15 ng-hide"
                    ng-show="registerForm.emailRePassword.$invalid && !registerForm.emailRePassword.$pristine">两次密码不一致！
                </li>
            </ul>
        </form>
    </div>
