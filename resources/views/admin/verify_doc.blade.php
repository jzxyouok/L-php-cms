...
<div class="content-wrapper" ng-controller="verifyDoc" ng-init="getDocById()">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" name="myForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <img src="/public/upload/image/doc-default.jpg" alt="" class=" col-sm-4"
                                         id="edit_doc_preview_img_preview"/>
                                    <p id="edit_doc_preview_img"></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary pull-right" ng-click="verifyDoc()">审核
                            </button>
                    ...
                    <script>
                        $('#edit_doc_preview_img').uploadify({
