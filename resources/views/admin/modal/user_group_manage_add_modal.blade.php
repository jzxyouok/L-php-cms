<!-- 模态框（Modal） -->
<div class="modal fade" id="user_group_manage_add_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true"
     ng-click="">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" ng-click="addUserGroup()">添加</button>
            </div>
        </div>
